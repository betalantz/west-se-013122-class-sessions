...
* Submitting the form creates a new quote and adds it to the list of quotes
  without having to refresh the page. Persistence to server is not required.

* Clicking the delete button should remove the respective quote from the
  page. Persistence to server is not required.

* Clicking the like button will update the number of likes displayed on the page without having to
  refresh. Persistence to the server is not required.
